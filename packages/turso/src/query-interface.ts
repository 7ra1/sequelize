...
import { TursoQueryInterfaceInternal } from './query-interface.internal.js';
import type { SqliteColumnsDescription } from './query-interface.types.js';

export class TursoQueryInterface<
  Dialect extends TursoDialect = TursoDialect,
> extends AbstractQueryInterface<Dialect> {
  readonly #internalQueryInterface: TursoQueryInterfaceInternal;

  constructor(dialect: Dialect, internalQueryInterface?: TursoQueryInterfaceInternal) {
    internalQueryInterface ??= new TursoQueryInterfaceInternal(dialect);
