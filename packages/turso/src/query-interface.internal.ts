...
import type { TursoQueryGenerator } from './query-generator.js';
import type { TursoQueryInterface } from './query-interface.js';
import type { SqliteColumnsDescription } from './query-interface.types.js';

export class TursoQueryInterfaceInternal extends AbstractQueryInterfaceInternal {
  constructor(readonly dialect: TursoDialect) {
    super(dialect);
  }
  ...
  get #queryGenerator(): TursoQueryGenerator {
    return this.dialect.queryGenerator;
  }

  get #queryInterface(): TursoQueryInterface {
